                        ...
                        <Card>
                            <div className="job-search">
                                <CardBody>
                                    ...
                                    <div className="job-description">
                                        <Button color="primary me-1"><span><i className="fa fa-check me-1"></i></span> {"Save this job"}</Button>
                                        <Button color="primary"><span><i className="fa fa-share-alt me-1"></i></span> {Share}</Button>
                                    </div>
                                </CardBody>
                            </div>
                        </Card>
                                                    ...
                                                    <Media>
                                                        ...
                                                        <Media body>
                                                            <h6 className="f-w-600"><a href="#javascript">{data.job_name}</a>
                                                                {(data.badgeType === 'primary' ? <span className="badge bg-primary pull-right">{data.badgeValue}</span>
                                                                    : ''
                                                                )}
                                                            </h6>
