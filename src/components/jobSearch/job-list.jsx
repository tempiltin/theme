                    ...
                    <Col xl="9 xl-60">
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/1.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">{UIandUX_IT_Frontend_Developer}</a><span className="badge bg-primary pull-right">{New}</span></h6>
                        ...
                        <div className="job-search">
                            ...
                            <Media><img className="img-40 img-fluid m-r-20" src={require("../../assets/images/job-search/2.jpg")} alt=""/>
                                <Media body>
                                <h6 className="f-w-600"><a href="#javascript">{ReactandReact_Native_Developer}</a><span className="badge bg-primary pull-right">{New}</span></h6>
