                                                ...
                                                return (
                                                    <Col xl="4 xl-50" md="6" key={i}>
                                                        <div className="browse-articles browse-bottom">
                                                            ...
                                                            <ul>
                                                                <li><a href='#javascript'><span><FileText /></span><span>{data.text1}</span><span className='badge bg-primary pull-right'>{data.text1_badge}</span></a></li>
                                                                <li><a href='#javascript'><span><FileText /></span><span>{data.text2}</span><span className='badge bg-primary pull-right'>{data.text2_badge}</span></a></li>
                                                                <li><a href='#javascript'><span><FileText /></span><span>{data.text3}</span><span className='badge bg-primary pull-right'>{data.text3_badge}</span></a></li>
                                                                <li><a href='#javascript'><span><FileText /></span><span>{data.text4}</span><span className='badge bg-primary pull-right'>{data.text4_badge}</span></a></li>
                        ...
                        <Row>
                            <Col xl="3 xl-50 box-col-6" md="6">
                                <Card className="features-faq product-box">
                                    ...
                                    <CardFooter><span>{"Dec 15, 2022"}</span><span className="pull-right"><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i></span></CardFooter>
                                </Card>
                            </Col>
                            <Col xl="3 xl-50 box-col-6" md="6">
                                <Card className="features-faq product-box">
                                    ...
                                    <CardFooter><span>{"Dec 15, 2022"}</span><span className="pull-right"><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star-o font-primary"></i></span></CardFooter>
                                </Card>
                            </Col>
                            <Col xl="3 xl-50 box-col-6" md="6">
                                <Card className="features-faq product-box">
                            ...
                            <Col xl="3 xl-50 box-col-6" md="6">
                                <Card className="features-faq product-box">
                                    ...
                                    <CardFooter><span>{"Dec 15, 2022"}</span><span className="pull-right"><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star-half-o font-primary"></i></span></CardFooter>
                                </Card>
                            </Col>
                        </Row>
                    </Col>
