                    ...
                    <Row>
                        ...
                        <Col xl="12">
                            <Card>
                                <CardHeader>
                                    <h5 className="mb-0">
                                        <Button color="link ps-0" onClick={() => setIsDesign(!isDesign)}
                                ...
                                <Collapse isOpen={isDesign}>
                                    <div className="collapse show" id="collapseicon1" aria-labelledby="collapseicon1" data-parent="#accordion">
                                        <div className="categories">
                                            ...
                                            <ul>
                                                <li><a href="#javascript">{UIDesign} </a><span className="badge bg-primary pull-right">{"28"}</span></li>
                                                <li><a href="#javascript">{UXDesign} </a><span className="badge bg-primary pull-right">{"35"}</span></li>
                                                <li><a href="#javascript">{InterfaceDesign} </a><span className="badge bg-primary pull-right">{"17"}</span></li>
                                                <li><a href="#javascript">{UserExperience} </a><span className="badge bg-primary pull-right">{"26"}</span></li>
                                            </ul>
                                        </div>
                                        <div className="categories pt-0">
                                            <div className="learning-header"><span className="f-w-600">{Development}</span></div>
                                            <ul>
                                                <li><a href="#javascript">{FrontendDevelopment}</a><span className="badge bg-primary pull-right">{"48"}</span></li>
                                                <li><a href="#javascript">{BackendDevelopment}</a><span className="badge bg-primary pull-right">{"19"}</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </Collapse>
                        ...
                        <Col xl="12">
                            <Card>
                                <CardHeader>
                                    <h5 className="mb-0">
                                        <Button color="link ps-0" onClick={() => setIsDevelopment(!isDevelopment)} data-toggle="collapse" data-target="#collapseicon2" aria-expanded="true" aria-controls="collapseicon2">{UpcomingCourses}</Button>
                                    </h5>
                                </CardHeader>
