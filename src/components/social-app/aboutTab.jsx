                                        ...
                                        <ul>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="twoImg" src={two} /><span className="d-block f-w-500">{JasonBorne}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="threeImg" src={three} /><span className="d-block f-w-500">{AnnaMull}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="threeImg" src={three} /><span className="d-block f-w-500">{DionCast}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="four" src={four} /><span className="d-block f-w-500">{KarleneLex}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="eightImg" src={eight} /><span className="d-block f-w-500">{VellaChism}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="tenImg" src={ten} /><span className="d-block f-w-500">{WaiSchalk}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="" src={fourteen} /><span className="d-block f-w-500">{KarleneLex}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <ul>
                                            <li>
                                                <div className="add-friend text-center">
                                                    ...
                                                    <span className="d-block f-w-500">{JasonBorne}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    ...
                                                    <span className="d-block f-w-500">{AnnaMull}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <Media body className="img-60 img-fluid rounded-circle" alt="" src={three} />
                                                    <span className="d-block f-w-500">{DionCast}</span>
                                                    <Button color="primary" size="xs">{AddFriend}</Button>
                                                </div>
                                            </li>
                                            <li>
                                ...
                                <CardBody>
                                    <div className="activity-log">
                                        <div className="my-activity">
                                            <h6 className="f-w-600 mb-3">{"Today"}</h6>
                                        ...
                                        <div className="my-activity">
                                            <h6 className="f-w-600 mb-3">{"25 December"}</h6>
                                            <p><span><ThumbsUp className="m-r-20" /></span>{"Comeren Diaz likes your photos."}</p>
                                            <p><span><ThumbsUp className="m-r-20" /></span>{"Johny Waston likes your post's."}</p>
                                            <p><span><UserPlus className="m-r-20" /></span>{"Karlene Lex and Comeren Diaz now friends."}</p>
                                            <p><span><UserPlus className="m-r-20" /></span>{"Johny Waston became friends with Bucky Barnes."}</p>
                                        ...
                                        <div className="my-activity">
                                            <h6 className="f-w-600 mb-3">{"8 september"}</h6>
                                            <p><span><ThumbsUp className="m-r-20" /></span>{"Comeren Diaz likes your photos."}</p>
                                            <p><span><ThumbsUp className="m-r-20" /></span>{"Johny Waston likes your post's."}</p>
                                            <p><span><UserPlus className="m-r-20" /></span>{"Karlene Lex and Comeren Diaz now friends."}</p>
                                            <p><span><UserPlus className="m-r-20" /></span>{"Johny Waston became friends with Bucky Barnes."}</p>
                                        ...
                                        <div className="my-activity">
                                            <h6 className="f-w-600 mb-3">{"6 June"}</h6>
                                            <p><span><ThumbsUp className="m-r-20" /></span>{"Comeren Diaz likes your photos."}</p>
                                            <p><span><UserPlus className="m-r-20" /></span>{"Karlene Lex and Comeren Diaz now friends."}</p>
                                            <p><span><MessageSquare className="m-r-20" /></span>{"Sarah Loren wrote on your timeline"}</p>
                                            <p><span><ThumbsUp className="m-r-20" /></span>{"Johny Waston likes your post's."}</p>
