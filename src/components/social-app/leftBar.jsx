                    ...
                    <Collapse isOpen={isProfile}>
                        <CardBody className="socialprofile filter-cards-view">
                            ...
                            <div className="social-btngroup d-flex">
                                ...
                                <Button color="light text-center ms-2" type="button">{View}</Button>
                            </div>
                    ...
                    <Collapse isOpen={isMutual}>
                        <CardBody className="social-status filter-cards-view">
                            ...
                            <Media>
                                ...
                                <Media body>
                                    <span className="f-w-500 d-block">{BuckyBarnes}</span><span className="d-block">{"winter@gmail.com"}</span>
                                </Media>
                            </Media>
                            <Media>
                                ...
                                <Media body>
                                    <span className="f-w-500 d-block">{SarahLoren}</span><span className="d-block">{"barnes@gmail.com"}</span>
                                </Media>
                            </Media>
                            <Media>
                                ...
                                <Media body>
                                    <span className="f-w-500 d-block">{JasonBorne}</span><span className="d-block">{"jasonb@gmail.com"}</span>
                                </Media>
                            </Media>
                            <Media>
                                ...
                                <div className="social-status social-offline"></div>
                                <Media body>
                                    <span className="f-w-500 d-block">{ComerenDiaz}</span><span className="d-block">{"comere@gmail.com"}</span>
                                </Media>
                            </Media>
                            <Media>
                                ...
                                <div className="social-status social-online"></div>
                                <Media body>
                                    <span className="f-w-500 d-block">{AndewJon}</span><span className="d-block">{"andrewj@gmail.com"}</span>
                                </Media>
                            </Media>
                            <Media>
                                ...
                                <div className="social-status social-busy"></div>
                                <Media body>
                                    <span className="f-w-500 d-block">{JohnyWaston}</span><span className="d-block">{"johny@gmail.com"}</span>
                                </Media>
                            </Media>
                            <Media>
                                ...
                                <div className="social-status social-offline"></div>
                                <Media body>
                                    <span className="f-w-500 d-block">{JohnyWilliam}</span><span className="d-block">{"johnyw@gmail.com"}</span>
                                </Media>
                            </Media>
                            <Media>
                                <img className="img-50 rounded-circle m-r-15" src={two} alt="twoImg" />
                    ...
                    <Collapse isOpen={isActivity}>
                        <CardBody className="social-status filter-cards-view">
                            <Media><Media className="img-50 rounded-circle m-r-15" src={ten} alt="tenImg" />
                                <Media body>
                                    <span className="f-w-500 d-block">{AndewJon}</span>
                            ...
                            <Media><Media className="img-50 rounded-circle m-r-15" src={three} alt="threeImg" />
                                <Media body>
                                    <span className="f-w-500 d-block">{JohnyWaston}</span>
                            ...
                            <Media><Media className="img-50 rounded-circle m-r-15" src={five} alt="fiveImg" />
                                <Media body>
                                    <span className="f-w-500 d-block">{ComerenDiaz}</span>
                            ...
                            <Media><Media className="img-50 rounded-circle m-r-15" src={four} alt="fourImg" />
                                <Media body>
                                    <span className="f-w-500 d-block">{SarahLoren}</span>
