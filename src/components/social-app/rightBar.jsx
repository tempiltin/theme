        ...
        <Fragment>
            ...
            <Col xl="12 xl-50 box-col-6">
                <Card>
                    <CardHeader>
                        <h5 className="mb-0">
                            <Button color="link ps-0" onClick={() => setisFollowers(!isFollowers)}
            ...
            <Col xl="12 xl-50 box-col-6">
                <Card>
                    <CardHeader>
                        <h5 className="mb-0">
                            <Button color="link ps-0" onClick={() => setisFollowings(!isFollowings)}
            ...
            <Col xl="12 xl-50 box-col-6">
                <Card>
                    <CardHeader>
                        <h5 className="mb-0">
                            <Button color="link ps-0" onClick={() => setisPhotos(!isPhotos)}
            ...
            <Col xl="12 xl-50 box-col-6">
                <Card>
                    <CardHeader>
                        <h5 className="mb-0">
                            <Button color="link ps-0" onClick={() => setisFriends(!isFriends)}
