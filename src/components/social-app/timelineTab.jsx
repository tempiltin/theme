...
import { Row, Col, Card, CardBody, Button, Media, InputGroup, InputGroupText, Input } from 'reactstrap';
                                        ...
                                        <div className="social-chat">
                                            <div className="your-msg">
                                                <Media>
                                                    ...
                                                    <Media body><span className="f-w-500">{JasonBorne} <span>{"1 Year Ago"} <i className="fa fa-reply font-primary"></i></span></span>
                                            ...
                                            <div className="other-msg">
                                                <Media>
                                                    ...
                                                    <Media body><span className="f-w-500">{AlexendraDhadio} <span>{"1 Month Ago"} <i className="fa fa-reply font-primary"></i></span></span>
                                            ...
                                            <div className="other-msg">
                                                <Media>
                                                    ...
                                                    <Media body><span className="f-w-500">{OliviaJon} <span>{"15 Days Ago"} <i className="fa fa-reply font-primary"></i></span></span>
                                                        <p>{"ohh yeah very good car and its features i will surely vote for it"} </p>
                                                    </Media>
                                                </Media>
                                            </div>
                                            <div className="your-msg">
                                                <Media>
                                                    <Media className="img-50 img-fluid m-r-20 rounded-circle" alt="" src={one} />
                                                    <Media body><span className="f-w-500">{IssaBell} <span>{"1 Year Ago"} <i className="fa fa-reply font-primary"></i></span></span>
                                                        <p>{"we are doing dance and singing songs, please vote our post which is very good for all young peoples"}</p>
                                                    </Media>
                                                </Media>
                                            </div>
