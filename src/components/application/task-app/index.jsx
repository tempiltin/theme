...
import { Printer, Link2, MoreHorizontal, Trash2, PlusCircle, CheckCircle } from 'react-feather';
                  ...
                  tasklist.map((tasklistdata, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>
                          <a className="me-2" href="#javascript"><Link2 /></a>
                      ...
                      <div className="media">
                        ...
                        <div className="media-body">
                          <Link to={`${process.env.PUBLIC_URL}/app/users/userProfile/${layout}`}>
                            <h6 className="f-w-500">{MARKJENCO}</h6></Link>
                          <p>{MARKJENCOEMAIL}</p>
                        </div>
                      </div>
                      <Nav className="main-menu" role="tablist">
                        <NavItem>
                          <button className="badge-light-primary btn-mail" onClick={addToggle}><CheckCircle className="me-2" />{NewTask}</button>
                              ...
                              <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(Addtask)}>
                                <Row>
                                  ...
                                  <FormGroup className="col-md-12">
                                    ...
                                    <Input className="js-example-disabled-results form-control" name="collection" type="select" >
                                ...
                                <Button color="primary mt-2" onClick={addToggle}>{Cancel}</Button>
                              </Form>
                            </ModalBody>
                          </Modal>
                        </NavItem>
