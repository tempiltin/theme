                    ...
                    <div className="email-app-sidebar left-bookmark">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <Link to={`${process.env.PUBLIC_URL}/app/users/userProfile/${layout}`}><h6 className="f-w-500">{MARKJENCO}</h6></Link>
                          <p>{MARKJENCOEMAIL}</p>
                        </div>
                      </div>
                      <Nav className="main-menu contact-options" role="tablist">
                        <NavItem>
                          <button className="badge-light-primary btn-mail" onClick={toggle}>
                          ...
                          <Modal className="modal-bookmark" isOpen={modal} toggle={toggle} size="lg">
                            ...
                            <ModalBody>
                              <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(AddContact)}>
                                ...
                                <Button color="secondary" className="me-1 mt-2">{Save}</Button>
                                <Button color="primary mt-2" onClick={toggle}>{Cancel}</Button>
                              </Form>
                            </ModalBody>
                          </Modal>
                        </NavItem>
                        ...
                        <li>
                          ...
                          <Modal className="modal-bookmark" isOpen={categoryModal} toggle={categoryToggle}>
                            ...
                            <ModalBody>
                              <Form className="form-bookmark">
                                ...
                                <Button color="secondary mt-2" onClick={categoryToggle} >{Save}</Button>
                                <Button color="primary" className="ms-1 mt-2" onClick={categoryToggle}>{Cancel}</Button>
                              </Form>
                            </ModalBody>
                          </Modal>
                        </li>
                                ...
                                {editing ?
                                  ...
                                  <div className="contact-editform ps-0 m-auto">
                                    <Form onSubmit={handleSubmit(UpdateContact)}>
                                      ...
                                      <Button color="secondary" className="update-contact me-1 mt-2">{Save}</Button>
                                      <Button color="primary mt-2" onClick={() => setEditing(false)}>{Cancel}</Button>
                                    </Form>
                                  </div>
                                  :
                            ...
                            <Row className="list-persons">
                              ...
                              <Col xl="8 xl-50" md="7">
                                <TabContent activeTab={orgactiveTab}>
                                  <TabPane tabId="1">
                                    <div className="profile-mail">
                                      <div className="media align-items-center"><img className="img-100 img-fluid m-r-20 rounded-circle update_img_5" src={require("../../../assets/images/user/user.png")} alt="" />
                                        <div className="media-body mt-0">
                                  ...
                                  <TabPane tabId="2">
                                    <div className="profile-mail">
                                      <div className="media align-items-center"><img className="img-100 img-fluid m-r-20 rounded-circle update_img_6" src={require("../../../assets/images/user/3.jpg")} alt="" />
                                        <div className="media-body mt-0">
                                  ...
                                  <TabPane tabId="3">
                                    <div className="profile-mail">
                                      <div className="media align-items-center"><img className="img-100 img-fluid m-r-20 rounded-circle update_img_7" src={require("../../../assets/images/user/4.jpg")} alt="" />
                                        <div className="media-body mt-0">
                                  ...
                                  <TabPane tabId="4">
                                    <div className="profile-mail">
                                      <div className="media align-items-center"><img className="img-100 img-fluid m-r-20 rounded-circle update_img_8" src={require("../../../assets/images/user/10.jpg")} alt="" />
                                        <div className="media-body mt-0">
                        ...
                        <div className="history-details">
                          ...
                          <div className="media"><i className="icofont icofont-star me-3"></i>
                            <div className="media-body mt-0">
                              ...
                              <p className="mb-0">{"Contact is created via mail"}</p><span className="f-12">{"Feb 10, 2022 4:00"}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      {selectedUser ?
                        <Modal className="modal-bookmark" isOpen={printmodal} toggle={printModalToggle} >
                          ...
                          <ModalBody className="list-persons">
                            ...
                            <Button color="primary mt-2" onClick={printModalToggle}>{Cancel}</Button>
