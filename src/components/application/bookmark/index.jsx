                    ...
                    <div className="email-app-sidebar left-bookmark">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <Link to={`${process.env.PUBLIC_URL}/app/users/userProfile/${layout}`}><h6 className="f-w-500">{MarkJecno}</h6></Link>
                          <p>{MARKJENCOEMAIL}</p>
                        </div>
                      </div>
                      <Nav className="main-menu" role="tablist">
                        <NavItem>
                          <button className="badge-light-primary btn-mail" onClick={addToggle}><Bookmark /> {NewBookmark}</button>
                          <Modal className="modal-bookmark" isOpen={addModal} toggle={addToggle} size="lg">
                            ...
                            <ModalBody>
                              <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <Button color="primary" className="mt-2" onClick={addToggle}>{Cancel}</Button>
                              </Form>
                            </ModalBody>
                          </Modal>
                        </NavItem>
                        ...
                        <Modal className="fade show modal-bookmark" isOpen={tagModal} toggle={tagToggle} size="lg">
                          ...
                          <ModalBody>
                            <Form className="form-bookmark needs-validation">
                              ...
                              <Button color="secondary mt-2" onClick={tagToggle}>{Save}</Button>
                              <Button color="primary m-l-5 mt-2" onClick={tagToggle}>{Cancel}</Button>
                            </Form>
                          </ModalBody>
                        </Modal>
                                            ...
                                            <div className="desciption-data">
                                              <div className="title-bookmark">
                                                ...
                                                <div className="hover-block">
                                                  <ul>
                                                    <li><a href="#javascript" onClick={() => editbookmarkdata(data)}><i className="fa fa-edit"></i></a></li>
                                                    <li><a href="#javascript"><i className="fa fa-link"></i></a></li>
                                                    <li><a href="#javascript"><i className="fa fa-share-alt"></i></a></li>
                                                    <li><a href="#javascript" onClick={() => Removefrombookmark(data.id)}><i className="fa fa-trash-o"></i></a></li>
                                                    <li className="pull-right text-end"><a href="#javascript"><i className="fa fa-tag"></i></a></li>
                                                  </ul>
                                                </div>
                                          ...
                                          <div className="details-website">
                                            ...
                                            <div className="desciption-data">
                                              <div className="title-bookmark">
                                                ...
                                                <div className="hover-block">
                                                  <ul>
                                                    <li><a href="#javascript" onClick={() => editbookmarkdata(mybookdata)}><i className="fa fa-edit"></i></a></li>
                                                    <li><a href="#javascript"><i className="fa fa-link"></i></a></li>
                                                    <li><a href="#javascript"><i className="fa fa-share-alt"></i></a></li>
                                                    <li><a href="#javascript" onClick={() => Remove_from_my_bookmark(mybookdata.id)}><i className="fa fa-trash-o"></i></a></li>
                                                    <li className="pull-right text-end"><a href="#javascript"><i className="fa fa-tag"></i></a></li>
                                                  </ul>
                                                </div>
                                                <div className="content-general">
                      ...
                      <Modal isOpen={editModal} toggle={editToggle} size="lg">
                        ...
                        <ModalBody>
                          <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(Updatebookmark)}>
                            ...
                            <Button color="secondary" className="me-1 mt-2">{Save}</Button>
                            <Button color="primary mt-2" onClick={editToggle}>{Cancel}</Button>
                          </Form>
                        </ModalBody>
                      </Modal>
                    </TabContent>
