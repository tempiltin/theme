                  ...
                  <CardBody>
                    <div className="email-app-sidebar">
                      <Media className="align-items-center">
                        ...
                        <Media body>
                          <Link to={`${process.env.PUBLIC_URL}/app/users/userProfile/${layout}`}><h6 className="f-w-600">{MARKJENCO}</h6></Link>
                          <p>{MARKJENCOEMAIL}</p>
                        </Media>
                      </Media>
                          ...
                          <div className="email-top compose-border">
                            <Row>
                              ...
                              <Col sm="4 xl-50" className="btn-middle text-end">
                                <Button color="primary" className="btn-mail text-center mb-0 mt-0">
