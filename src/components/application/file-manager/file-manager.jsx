...
import { Container, Row, Col, Card, CardHeader, CardBody, Form, Input } from 'reactstrap'
    ...
    return (
      <li className="file-box" key={i}>
        ...
        <div className="file-bottom">
          <h6>{data.name} </h6>
          <p className="mb-0 mt-1">{data.size}</p>
          <p> <span>{"last open"} : </span>{data.modify}</p>
        </div>
      </li>
    )
  })
                ...
                <CardHeader>
                  <div className="media">
                    ...
                    <div className="media-body text-end">
                      ...
                      <div className="btn btn-outline-primary ms-1" onClick={onFileUpload}><Upload />{"Upload"}</div>
                    </div>
                  </div>
                </CardHeader>
                {filelist.length > 0 ?
