                                            ...
                                            <Table className="table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colSpan="4">
                                                            <InputGroup>
                                                                <Input className="form-control me-2" type="text" placeholder="Enter coupan code" /><Button color="primary">{Apply}</Button>
                                                            </InputGroup>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td className="text-end" colSpan="5"><Link to={`${process.env.PUBLIC_URL}/app/ecommerce/product/${layout}`} className="btn btn-secondary cart-btn-transform" >{ContinueShopping}</Link></td>
                                                        <td><Link to={`${process.env.PUBLIC_URL}/app/ecommerce/checkout/${layout}`} className="btn btn-success cart-btn-transform">{CheckOut}</Link></td>
                                                    </tr>
                                                </tbody>
                                            </Table>
                                        </div>
