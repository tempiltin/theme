...
const Pricing = (props) => {
  return (
    <Fragment>
      <Breadcrumb parent="Ecommerce" title="Pricing" />
                    ...
                    <Row className="pricing-block">
                      ...
                      <Col lg="3" md="6 box-col-6">
                        <div className="pricingtable">
                          ...
                          <div className="price-value"><span className="currency">{"$"}</span><span className="amount">{"30"}</span><span className="duration">{"/mo"}</span></div>
                          <ul className="pricing-content">
                      ...
                      <Col lg="3" md="6 box-col-6">
                        <div className="pricingtable">
                          ...
                          <div className="price-value"><span className="currency">{"$"}</span><span className="amount">{"40"}</span><span className="duration">{"/mo"}</span></div>
                          <ul className="pricing-content">
                            <li>{"Upload 50 product"}</li>
                            <li>{"50 Email Accounts"}</li>
                            <li>{"Maintenance"}</li>
                    ...
                    <Row>
                      <Col xl="3 xl-50" sm="6" className="box-col-6">
                        <Card className="text-center pricing-simple">
                          ...
                          </CardBody><Button size="lg" color="primary">
