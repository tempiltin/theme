                  ...
                  <CardHeader className="card-no-border">
                    <div className="media">
                      <div className="media-body">
                        <p><span className="f-w-500 font-roboto">{TodayTotalSale}</span><span className="f-w-700 font-primary ms-2">{"89.21%"}</span></p>
                    ...
                    <div className="media">
                      <div className="media-body">
                        <div className="profit-card">
                          <ApexCharts id="spaline-chart" options={Monthlysales.options} series={Monthlysales.series} type='area' width={650} height={150} />
                        </div>
                      </div>
                    </div>
                  </CardBody>
              ...
              <Col xl="6" className="box-col-6" md="6">
                <Card className="o-hidden">
                  <CardHeader className="card-no-border">
                    <div className="media">
                      <div className="media-body">
                        <p><span className="f-w-500 font-roboto">{TodayTotalVisits}</span><span className="f-w-700 font-primary ms-2">{"35.00%"}</span></p>
                ...
                <Card className="o-hidden">
                  <CardBody>
                    <div className="ecommerce-widgets media">
                      <div className="media-body">
                        <p className="f-w-500 font-roboto">{OurSaleValue}<span className="badge pill-badge-primary ms-3">{New}</span></p>
              ...
              <Col xl="6" lg="12" md="6" className="box-col-6">
                <Card className="o-hidden">
                  <CardBody>
                    <div className="media">
                      <div className="media-body">
                        <p className="f-w-500 font-roboto">{TodayStockValue}<span className="badge pill-badge-primary ms-3">{Hot}</span></p>
          ...
          <Col xl="5 xl-50" className="box-col-12">
            <Card className="o-hidden dash-chart">
              <CardHeader className="card-no-border">
                <div className="media">
                  <div className="media-body">
                    <p><span className="f-w-500 font-roboto">{TotalProfit}</span><span className="font-primary f-w-700 ms-2">{"99.00%"}</span></p>
                    <h4 className="f-w-500 mb-0 f-26">{"$"}<span className="counter"><CountUp end={300056} /></span></h4>
                  </div>
                </div>
              </CardHeader>
                                ...
                                <div className="col-xl-4 col-md-6">
                                  <div className="d-flex">
                                    <div className="left-content">
                                      ...
                                      <h4 className="f-w-600">{"Best Selling Product"}</h4><span className="badge badge-white rounded-pill">{"78% offer"}</span><span className="badge badge-dotted rounded-pill ms-2">{CouponCode} : {"12345"}</span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-md-6">
                                  <div className="d-flex">
                                    <div className="right-content">
                                      ...
                                      <h4 className="f-w-600">{"Women Straight Kurta"}</h4><span className="badge badge-white rounded-pill">{"$100.00"}</span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="selling-slide row">
                                ...
                                <div className="col-xl-4 col-md-6">
                                  <div className="d-flex">
                                    <div className="right-content">
                                      <p>{"Money back Guarrantee"}</p>
                                      <h4 className="f-w-600">{"Nike Air Shoes"}</h4><span className="badge badge-white rounded-pill">{"$120.55"}</span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div className="col-xl-4 col-md-6">
                                  <div className="d-flex">
                                    <div className="left-content">
                                      ...
                                      <h4 className="f-w-600">{"Best Selling Product"}</h4><span className="badge badge-white rounded-pill">{"50% offer"}</span><span className="badge badge-dotted rounded-pill ms-2">{CouponCode} : {"21546"}</span>
                                    </div>
                                  </div>
                                </div>
                                <div className="col-xl-4 col-md-12">
                          ...
                          <Table borderless>
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div className="d-inline-block align-middle"><img className="img-40 m-r-15 rounded-circle align-top" src={require("../../assets/images/avtar/7.jpg")} alt="" />
                                    ...
                                    <div className="d-inline-block"><span>{Johnketer}</span>
                                      <p className="font-roboto">{"2022"}</p>
                                    </div>
                                  </div>
                                </td>
                                <td>{"06 August"}</td>
                                ...
                                <td className="text-end"><i className="fa fa-check-circle"></i>{Done}</td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td className="text-end"><i className="fa fa-check-circle"></i>{Pending}</td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td className="text-end"><i className="fa fa-check-circle"></i>{Success}</td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <td className="text-end"> <i className="fa fa-check-circle"></i>{InProcess}</td>
                              </tr>
                              <tr>
                                <td>
