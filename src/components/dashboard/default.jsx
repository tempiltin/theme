                ...
                <div className="chat">
                  ...
                  <div className="media right-side-chat">
                    ...
                    <div className="media-body text-end">
                      <div className="message-main pull-right"><span className="mb-0 text-start">{"How can do for you"}</span>
                  ...
                  <div className="media left-side-chat">
                    <div className="media-body d-flex">
                      <div className="img-profile"> <img className="img-fluid" src={require("../../assets/images/User.jpg")} alt="Profile" /></div>
                      <div className="main-chat">
                        <div className="sub-message message-main mt-0"><span>{"It's Urgently"}</span></div>
                      </div>
                    </div>
                    <p className="f-w-400">{"7:28 PM"}</p>
                  </div>
                  <div className="media right-side-chat">
                    <div className="media-body text-end">
                      <div className="message-main pull-right"><span className="loader-span mb-0 text-start" id="wave"><span className="dot"></span><span className="dot"></span><span className="dot"></span></span></div>
                    </div>
                  </div>
