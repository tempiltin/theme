        ...
        <Row>
          ...
          <Col sm="12" xl="12">
            <Card>
              ...
              <CardBody>
                <ListGroup>
                  <ListGroupItem className="d-flex justify-content-between align-items-center">{"Cras justo odio"}<span className="badge bg-primary counter digits">{"14"}</span></ListGroupItem>
                  ...
                  <ListGroupItem className="d-flex justify-content-between align-items-center">{"Morbi leo risus"}<span className="badge badge-success rounded-pill counter digits">{"1"}</span></ListGroupItem>
                  <ListGroupItem className="d-flex justify-content-between align-items-center">{"Dapibus ac facilisis in"}<span className="badge badge-info rounded-pill digits">{"100%"}</span></ListGroupItem>
                  ...
                  <ListGroupItem className="d-flex justify-content-between align-items-center">{"Morbi leo risus"}<span className="badge badge-danger rounded-pill digits">{"sale"}</span></ListGroupItem>
                  <ListGroupItem className="d-flex justify-content-between align-items-center">{"Cras justo odio"}<span className="badge badge-light txt-dark counter digits">{"14"}</span></ListGroupItem>
                </ListGroup>
              </CardBody>
            </Card>
          </Col>
            ...
            <Card>
              ...
              <CardBody>
                <ListGroup>
                  ...
                  <ListGroupItem className="list-group-item-action" tag="a" href="#javascript"><i className="icon-target"></i>{"Dapibus ac facilisis"}</ListGroupItem>
            ...
            <Card>
              ...
              <CardBody>
                <ListGroup>
                  ...
                  <ListGroupItem className="list-group-item-action" tag="a" href="#javascript">
                    <Media body src={require("../../assets/images/user/1.jpg")} alt="" />{"Dapibus ac facilisis"}</ListGroupItem>
                  <ListGroupItem className="list-group-item-action" tag="a" href="#javascript">
            ...
            <Card>
              ...
              <CardBody>
                <ListGroup>
                  ...
                  <ListGroupItem className="list-group-item-action" tag="a" href="#javascript">
                    <Media body className="rounded-circle" src={require("../../assets/images/user/1.jpg")} alt="" />{"Dapibus ac facilisis"}</ListGroupItem>
                  <ListGroupItem className="list-group-item-action" tag="a" href="#javascript">
