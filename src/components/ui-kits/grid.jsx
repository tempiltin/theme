...
import {ColumnOrdering,GridColumn,NestingColumn,GridOptions,ExtraSmall,Small,Medium,Large,ExtraLarge,ExtraextraLarge,GridBehavior,GutterWidth,Nestable,Offsets,VerticalAlignment,HorizontalAlignment,Order} from '../../constant'
const Grid = (props) => {
    return (
        <Fragment>
