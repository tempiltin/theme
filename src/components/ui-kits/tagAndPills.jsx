...
const TagAndPills = (props) => {
    return (
      <Fragment>
        ...
        <Container fluid={true} className="tag-pill">
        <Row>
              <Col sm="12" xl="6">
                <Card>
                  <CardHeader>
                  ...
                  <CardBody>
                      ...
                      <Badge color="light text-dark">{Light}</Badge><Badge color="dark tag-pills-sm-mb">{Dark}</Badge>
                </CardBody>
                </Card>
              </Col>
              <Col  sm="12" xl="6">
                <Card>
                  ...
                  <CardBody>
                    ...
                    <Badge color="light text-dark" pill>{Light}</Badge>
              ...
              <Col  sm="12" xl="6">
                <Card>
                  ...
                  <CardBody className="digits">
                      ...
                      <Badge color="light text-dark" href="#javascript">{"7"}</Badge>
              ...
              <Col  sm="12" xl="6">
                <Card>
                  ...
                  <CardBody className="digits">
                      ...
                      <Badge color="light text-dark" pill>{"7"}</Badge>
              ...
              <Col  sm="12" xl="6">
                <Card>
                  ...
                  <CardBody>
                      ...
                      <Badge color="light text-dark" href="#javascript" pill><Heart/></Badge>
                  ...
                  <CardBody>
                    <div className="mb-3">
                      <Button color="primary">
                        {Messages} <Badge color="light text-dark" pill><Mail/></Badge>
                      </Button>
                    </div>
                    <div className="mb-3">
                      <Button color="secondary" type="button">
                        {Notification} <Badge color="light text-dark" pill><Bell/></Badge></Button>
                    </div>
                    <div className="mb-3">
                      <Button color="success">{"Update available"} <Badge color="light text-dark" pill><Settings/></Badge></Button>
                    </div>
                    <div className="mb-3">
                      <Button color="info">{"Playing Now"} <Badge color="light text-dark" pill><Music/></Badge></Button>
                    </div>
                    <div className="mb-3">
                      <Button color="warning">{"1.2 GB Used"} <Badge color="light text-dark" pill><AlertTriangle/></Badge></Button>
                    </div>
                    <div>
                      <Button color="danger">{"Alert"} <Badge color="light text-dark" pill><AlertCircle/></Badge></Button>
                    </div>
                  </CardBody>
                </div>
              </Col>
