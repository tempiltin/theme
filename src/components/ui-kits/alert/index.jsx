                ...
                <Card>
                  ...
                  <CardBody className="dismiss-text">
                    <Alert color="primary inverse alert-dismissible" ><i className="icon-timer"></i>
                     <p>{"Your time Over after"} <b>{"5"}</b> {"minute"}</p><button className="btn-close"><span className="bg-primary ">{"dismiss"}</span> </button>
                    </Alert>
                    <Alert color="secondary inverse alert-dismissible" ><i className="icon-heart"></i>
                     <p>{"Oh snap! Change a few things up and submit again."}</p><button className="btn-close"><span className="bg-secondary" >{"dismiss"}</span></button>
                    </Alert>
                    <Alert color="success inverse alert-dismissible" ><i className="icon-thumb-up alert-center"></i>
                    <p><b> {"Well done!"} </b>{"You successfully read this important alert message."}</p> <button className="btn-close"><span className="bg-success" >{"dismiss"}</span></button>
                    </Alert>
                    <Alert color="info inverse alert-dismissible"><i className="icon-help-alt"></i>
                    <p><b>{"Welcome!"}</b> {"Start your day with some alerts."}</p>
                    <button className="btn-close"><span className="bg-info" >{"dismiss"}</span></button>
                    </Alert>
                    ...
                    <button className="btn-close"><span className="bg-warning" >{"dismiss"}</span></button>
                    </Alert>
                    <Alert color="danger inverse alert-dismissible" ><i className="icon-thumb-down"></i>
                    <p>{"Your"}  <b> {"Perfomance"} </b> {"is down on this week"}</p>
                    <button className="btn-close"><span className="bg-danger" >{"dismiss"}</span></button>
                    </Alert>
                    ...
                    <button className="btn-close"><span className="bg-light  txt-dark" >{"dismiss"}</span></button>
                    </Alert>
                    <Alert color="dark inverse alert-dismissible" ><i className="icon-info-alt"></i>
                    <p> {"You can check in on some of those fields below."}</p>
                    <button className="btn-close"><span className="bg-dark txt-light" >{"dismiss"}</span></button>
                    </Alert>
                  </CardBody>
                </Card>
              </Col>
