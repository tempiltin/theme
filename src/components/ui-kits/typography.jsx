          ...
          <Col sm="12">
            <Card>
              ...
              <CardBody>
                ...
                <footer className="blockquote-footer mt-0">{"Someone famous in"}
                ...
                <footer className="blockquote-footer text-center mt-0">{"Someone famous in"}
                        <cite title="Source Title">{SourceTitle}</cite>
                </footer>
                ...
                <footer className="blockquote-footer text-end mt-0">{"Someone famous in"}
                        <cite title="Source Title">{SourceTitle}</cite>
                </footer>
              </CardBody>
            </Card>
