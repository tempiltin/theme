      ...
      <Container fluid={true}>
        <Row>
          <Col sm="12">
            ...
            <Card>
              ...
              <CardBody>
                <Form className="was-validated">
                  ...
                  <div className="custom-control custom-radio form-check">
                  ...
                  <div className="custom-control custom-radio mb-3 form-check">
            ...
            <Card>
              <CardHeader>
                <h5>{Tooltips}</h5><span>{"If your form layout allows it, you can swap the"} <code className="font-danger">{".feedback"}</code> {"classes for"} <code className="font-danger">{".tooltip"}</code> {"classes to display validation feedback in a styled tooltip. Be sure to have a parent with"} <code className="font-danger">{"position: relative"}</code> {"on it for tooltip positioning. In the example below, our column classes have this already, but your project may require an alternative setup."}</span>
              </CardHeader>
              <CardBody>
                <TooltipForm />
              </CardBody>
